    ...
    class RoadTripController < ApplicationController
      ...
      def create
        ...
        if time.instance_of?(String)
          ...
          render json: RoadTripSerializer.api_format(origin, destination, time, eta_weather), status: :created
        else
          eta = time.eta_time
          ...
          render json: RoadTripSerializer.api_format(origin, destination, time.travel_time, eta_weather),
                 status: :created
        end
      end
